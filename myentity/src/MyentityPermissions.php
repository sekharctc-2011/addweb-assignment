...
use Drupal\myentity\Entity\Myentity;


/**
 * Provides dynamic permissions for Myentity of different types.
 *
 * @ingroup myentity
 *
 */
class MyentityPermissions{
   ...
   *
   * @return array
   *   The Myentity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (Myentity::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\myentity\Entity\Myentity $type
   *   The Myentity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(Myentity $type) {
    $type_id = $type->id();
